...
python main_gemini.py --use_api True --api_model "models/gemini-flash-lite-latest" --problem_name oscillator2 --spec_path ./specs/specification_oscillator2_torch.txt --log_path ./logs/oscillator2_gemini_flash_lite