...
parser.add_argument('--api_type', type=str, default="gemini", choices=['openai', 'gemini', 'auto'], help='API type to use')
parser.add_argument('--api_model', type=str, default="models/gemini-flash-lite-latest", help='Model name for API calls')
parser.add_argument('--spec_path', type=str,default="./specs/specification_oscillator1_numpy.txt")
parser.add_argument('--log_path', type=str, default="./logs/oscillator1_gemini_flash_lite")
...
if __name__ == '__main__':
    ...
    global_max_sample_num = 10 # for test  
