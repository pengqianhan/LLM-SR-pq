...
parser.add_argument('--temperature', type=float, default=0.7)#Qwen/Qwen3-30B-A3B-Instruct-2507
parser.add_argument('--do_sample', type=bool, default=True)
parser.add_argument('--max_new_tokens', type=int, default=512)
parser.add_argument('--top_k', type=int, default=20)#Qwen/Qwen3-30B-A3B-Instruct-2507
parser.add_argument('--top_p', type=float, default=0.8)#Qwen/Qwen3-30B-A3B-Instruct-2507
parser.add_argument('--eos_token_id', type=int, default=151643)#Qwen/Qwen3-30B-A3B-Instruct-2507
parser.add_argument('--pad_token_id', type=int, default=151643)#Qwen/Qwen3-30B-A3B-Instruct-2507
