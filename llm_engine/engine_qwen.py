...
parser.add_argument('--temperature', type=float, default=0.6)#Qwen/Qwen3-8B
parser.add_argument('--do_sample', type=bool, default=True)
parser.add_argument('--max_new_tokens', type=int, default=512)
parser.add_argument('--top_k', type=int, default=20)#Qwen/Qwen3-8B
parser.add_argument('--top_p', type=float, default=0.95)#Qwen/Qwen3-8B
parser.add_argument('--eos_token_id', type=int, default=151643)#Qwen/Qwen3-8B
parser.add_argument('--pad_token_id', type=int, default=151643)#Qwen/Qwen3-8B
